...
const receiptRows = (receipt: TransferReceiptData) => [
  ...
  [
    ...
    receipt.appointmentsCount != null ? String(receipt.appointmentsCount) : "—",
  ],
...
const downloadTransferReceiptPDF = async (receipt: TransferReceiptData) => {
  ...
  doc.setFontSize(9);
  doc.text(
    "Este comprovante registra o repasse financeiro processado pela plataforma.",
    20,
    72,
  );
  ...
  doc.setFontSize(8);
  doc.text(
    "Documento gerado automaticamente com base no registro de saque/repasse da plataforma.",
    14,
    y + 12,
  );
  doc.text(
    "Valores sujeitos à conciliação administrativa e bancária quando aplicável.",
    14,
    y + 18,
  );
          ...
          >
            <div className="relative overflow-hidden bg-gradient-to-br from-emerald-950 via-slate-950 to-blue-950 p-6 text-white md:p-8">
              ...
              <div className="relative flex items-start justify-between gap-3">
                <div className="flex min-w-0 items-start gap-3 sm:gap-4">
                  <div className="hidden h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-white/10 text-emerald-200 ring-1 ring-white/15 sm:flex">
            ...
            <div className="grid gap-4 p-5 md:grid-cols-3 md:p-8">
              ...
              <div className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm shadow-slate-200/70 dark:border-white/10 dark:bg-white/5 dark:shadow-none">
                ...
                <p className="mt-1 text-sm font-black text-slate-950 dark:text-white">
                  {receipt.professionalName || "Fisioterapeuta"}
                </p>
              </div>
              <div className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm shadow-slate-200/70 dark:border-white/10 dark:bg-white/5 dark:shadow-none">
            ...
            <div className="px-5 pb-5 md:px-8 md:pb-8">
              ...
              <div className="mt-5 rounded-2xl border border-emerald-200 bg-emerald-50 p-4 text-xs font-semibold leading-relaxed text-emerald-900 dark:border-emerald-500/20 dark:bg-emerald-500/10 dark:text-emerald-100">
                Este comprovante confirma o registro de repasse na plataforma.
                Guarde este documento para controle financeiro.
              </div>
