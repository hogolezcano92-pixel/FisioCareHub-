...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // O Supabase já inicializa a sessão automaticamente ao criar o cliente e
    // emite INITIAL_SESSION neste listener. Evitamos chamar getSession() em
    // paralelo: nas versões antigas do auth-js essa combinação podia deixar o
    // Web Lock de autenticação órfão e bloquear signInWithPassword para sempre.
    // O callback permanece síncrono; o SELECT do perfil é adiado acima.
