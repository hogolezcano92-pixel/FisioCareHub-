    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <AnimatePresence>
        {selectedMarketingNotification && (() => {
          ...
          return createPortal(
            <motion.div className="fixed inset-0 z-[2147483647] flex items-start justify-center overflow-y-auto bg-slate-950/70 px-4 py-6 sm:py-10 md:py-14 backdrop-blur-md" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} onMouseDown={(e)=>{if(e.target===e.currentTarget)setSelectedMarketingNotification(null)}}>
