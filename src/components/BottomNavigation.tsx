  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md pointer-events-auto">
        <div className="relative overflow-hidden rounded-[2rem] border border-slate-200/90 bg-white/92 shadow-[0_18px_55px_rgba(15,23,42,0.18)] backdrop-blur-2xl dark:border-white/12 dark:bg-slate-950/82 dark:shadow-[0_24px_70px_rgba(2,6,23,0.55)]">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-50/90 via-violet-50/75 to-cyan-50/80 dark:from-blue-500/12 dark:via-violet-500/10 dark:to-cyan-400/10" />
          <div className="absolute inset-x-8 -top-10 h-20 rounded-full bg-blue-400/20 blur-3xl dark:bg-blue-500/20" />
                ...
                >
                  ...
                  <span
                    className={cn(
                      ...
                      active ? 'scale-110 drop-shadow-[0_0_12px_rgba(255,255,255,0.55)]' : 'text-slate-600 dark:text-slate-300'
                    )}
                  >
                  ...
                  <span
                    className={cn(
                      ...
                      active ? 'opacity-100' : 'opacity-95 dark:opacity-85'
                    )}
                  >
                    {item.name}
                  </span>
