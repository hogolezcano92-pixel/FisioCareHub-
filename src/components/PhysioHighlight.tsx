          ...
          <div className="relative w-24 h-24 sm:w-28 sm:h-28 flex items-center justify-center">
            <AnimatePresence mode="wait">
              <motion.img
                ...
                src={PATIENT_IMAGES[index]}
                alt="Paciente Real"
                className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full border-4 border-blue-500/20 object-cover flex-shrink-0 shadow-2xl shadow-blue-500/20"
