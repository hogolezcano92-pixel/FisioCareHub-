...
export default function PostLoginSplash({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="fch-splash-orb absolute -left-24 top-10 -z-10 h-[34rem] w-[22rem] rounded-full bg-cyan-400/20 blur-3xl"
        animate={{ scale: [1, 1.16, 1], opacity: [0.42, 0.72, 0.42] }}
        transition={{ duration: 4.5, repeat: Infinity, ease: 'easeInOut' }}
      />
      <motion.div
        className="fch-splash-orb absolute -right-20 bottom-4 -z-10 h-[28rem] w-[34rem] rounded-full bg-fuchsia-500/28 blur-3xl"
        animate={{ scale: [1, 1.12, 1], opacity: [0.4, 0.76, 0.4] }}
        transition={{ duration: 5.2, repeat: Infinity, ease: 'easeInOut' }}
      />

      <div className="fch-splash-particle absolute inset-0 -z-10 opacity-55 [background-image:radial-gradient(circle_at_center,rgba(255,255,255,0.42)_1px,transparent_1.4px)] [background-size:32px_32px]" />
      ...
      >
        <motion.div
          className="fch-splash-card mx-auto mb-7 flex w-fit items-center justify-center rounded-[2rem] border border-white/25 bg-slate-950/45 px-7 py-5 shadow-[0_24px_90px_rgba(0,0,0,0.45),0_0_80px_rgba(56,189,248,0.22)] backdrop-blur-2xl"
        ...
        >
          <div className="fch-splash-title select-none text-3xl font-black tracking-tight sm:text-4xl" aria-label="FisioCareHub">
        ...
        <motion.div
          className="fch-splash-glass mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-full border border-cyan-200/45 bg-slate-950/35 shadow-[0_0_80px_rgba(34,211,238,0.48)] backdrop-blur-xl"
        ...
        <motion.p
          className="fch-splash-muted mb-3 text-sm font-black uppercase tracking-[0.34em] text-cyan-100 drop-shadow-[0_0_14px_rgba(103,232,249,0.65)]"
        ...
        >
          ...
          <p className="fch-splash-muted mt-4 text-xs font-black uppercase tracking-[0.26em] text-slate-200/95">
