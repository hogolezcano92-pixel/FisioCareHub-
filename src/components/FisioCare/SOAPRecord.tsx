        ...
        <AnimatePresence mode="wait">
          <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md space-y-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-white/10 dark:bg-slate-900"
            >
              <div className="text-center">
                ...
                <h3 className="text-xl font-black text-slate-950 dark:text-white">Atribuir Paciente</h3>
                <p className="mt-2 text-xs font-medium text-slate-600 dark:text-slate-400">Selecione o paciente para vincular este prontuário.</p>
              </div>

              <div className="space-y-4">
                <div className="flex h-14 w-full items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 text-slate-900 shadow-sm transition-all focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-500/20 dark:border-white/10 dark:bg-white/5 dark:text-white">
                  ...
                  <input
                    ...
                    className="h-full min-w-0 flex-1 bg-transparent text-sm font-medium text-slate-900 outline-none placeholder:truncate placeholder:text-slate-400 dark:text-white dark:placeholder:text-slate-600"
                  />
                </div>
                  ...
                  {searching ? (
                    ...
                    searchResults.map((p) => (
                      <button
                        ...
                        className="group flex w-full items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 p-3 text-left transition-all hover:border-blue-500/30 hover:bg-blue-50 dark:border-white/5 dark:bg-white/5 dark:hover:bg-white/10"
                      >
                        <img
                        ...
                        <div className="min-w-0 flex-1 text-left">
                          <p className="truncate text-sm font-bold text-slate-900 transition-colors group-hover:text-blue-600 dark:text-white dark:group-hover:text-blue-300">{p.nome_completo}</p>
                          <p className="truncate text-[10px] text-slate-500 dark:text-slate-500">{p.email || 'Sem e-mail'}</p>
                        </div>
              ...
              <button
                onClick={() => setShowPatientSelector(false)}
                className="w-full py-3 text-[10px] font-black uppercase tracking-widest text-slate-600 transition-colors hover:text-slate-950 dark:text-slate-500 dark:hover:text-white"
              >
                Cancelar
              </button>
            </motion.div>
