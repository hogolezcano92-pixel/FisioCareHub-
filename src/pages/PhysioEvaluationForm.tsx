  ...
  return (
    <section className="rounded-[2rem] border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-slate-900/60 dark:shadow-none backdrop-blur-xl overflow-hidden">
      <div className="px-6 py-4 border-b border-slate-200 dark:border-white/10 flex items-center gap-3">
        ...
        <h2 className="text-sm font-black text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-widest">{title}</h2>
      </div>
...
function Field({ label, value, onChange, placeholder = '', type = 'text', min, max }: any) {
  return (
    <label className="block space-y-1.5">
      <span className="text-[10px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-600 dark:text-slate-500">{label}</span>
      {type === 'textarea' ? (
