...
export default function Admin() {
  ...
  return (
    <div className="flex font-sans w-full min-h-screen bg-[#F8FAFC] overflow-x-hidden relative">
      ...
      <aside 
        className={cn(
          "fixed inset-y-0 left-0 z-[110] w-[280px] bg-[#0F172A] border-r border-white/10 backdrop-blur-xl transition-all duration-300 ease-in-out lg:relative lg:translate-x-0 overflow-hidden",
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[#F8FAFC]">
        {/* Header */}
        <header className="h-20 sticky top-0 z-40 flex items-center justify-between px-8 bg-white/95 border-b border-slate-200 backdrop-blur-md pt-6 lg:pt-0">
          <button 
            className="lg:hidden p-3 text-slate-700 hover:bg-slate-100 rounded-2xl transition-all" 
          ...
          <div className="flex-1 px-4 lg:px-0">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 mb-1">Administrator Panel</p>
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={toggleTheme}
              className="p-2.5 text-slate-500 hover:text-slate-900 hover:bg-slate-100 border border-transparent hover:border-slate-200 rounded-xl transition-all"
            >
              <Sun size={20} />
            </button>
            <button className="p-2.5 text-slate-500 hover:text-slate-900 hover:bg-slate-100 border border-transparent hover:border-slate-200 rounded-xl transition-all relative">
              <Bell size={20} />
              <div className="absolute top-3 right-3 w-2 h-2 bg-[#6D5DFB] rounded-full border-2 border-white" />
            </button>
          </div>
        </header>
