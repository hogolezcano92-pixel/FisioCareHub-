    ...
    <div className="min-h-screen pt-4 md:pt-8 pb-12 bg-[#0B1120] relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 md:space-y-10 relative z-10">
        ...
        <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white/5 backdrop-blur-3xl p-4 md:p-5 rounded-[2rem] border border-white/10 shadow-2xl shadow-blue-900/20 relative overflow-hidden">
          ...
          <header className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 backdrop-blur-3xl shadow-2xl shadow-blue-900/20">
            {/* Capa horizontal do paciente - visual limpo inspirado no perfil do fisioterapeuta */}
            <div className="relative h-36 sm:h-40 md:h-48 overflow-hidden border-b border-white/10 bg-[#17233d]">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_82%_18%,rgba(125,211,252,0.22),transparent_32%),radial-gradient(circle_at_18%_25%,rgba(139,92,246,0.22),transparent_34%),linear-gradient(135deg,rgba(14,165,233,0.18),rgba(79,70,229,0.18)_45%,rgba(15,23,42,0.92))]" />
              <div className="absolute inset-0 opacity-45 bg-[linear-gradient(to_right,#ffffff12_1px,transparent_1px),linear-gradient(to_bottom,#ffffff10_1px,transparent_1px)] bg-[size:42px_42px]" />
              <div className="absolute -left-20 bottom-[-4.5rem] h-44 w-[70%] rounded-full bg-sky-400/20 blur-[70px]" />
              <div className="absolute right-[-5rem] top-[-5rem] h-56 w-56 rounded-full bg-violet-500/25 blur-[80px]" />
              <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#111c33] via-[#111c33]/78 to-transparent" />

              <div className="absolute left-5 top-5 sm:left-8">
                <div className="inline-flex items-center gap-2 rounded-full border border-sky-300/25 bg-white/10 px-4 py-2 text-[10px] font-black uppercase tracking-[0.22em] text-sky-200 shadow-lg shadow-sky-950/20 backdrop-blur-xl">
            ...
            <div className="relative px-5 pb-6 pt-0 sm:px-8 md:px-10 md:pb-8">
              <div className="flex flex-col gap-4 md:flex-row md:items-end md:gap-6">
                {!profile ? (
                  <div className="-mt-12 h-24 w-24 rounded-full border-4 border-[#111c33] bg-slate-800 animate-pulse" />
                ) : (
                  <div className="relative -mt-12 shrink-0 group">
                    <div className="absolute -inset-2 rounded-full bg-gradient-to-tr from-sky-400 via-blue-500 to-violet-500 opacity-35 blur-xl transition duration-500 group-hover:opacity-55" />
                    <img
                      src={profile.avatar_url || `https://api.dicebear.com/7.x/avataaars/svg?seed=${profile.id}`}
                      alt={profile.nome_completo}
                      className="relative h-24 w-24 rounded-full border-4 border-[#111c33] object-cover shadow-2xl sm:h-28 sm:w-28"
                    />
                    <div className="absolute bottom-3 right-1 h-5 w-5 rounded-full border-[3px] border-[#111c33] bg-emerald-400 shadow-lg shadow-emerald-500/30" />
                  </div>
                )}

                <div className="min-w-0 flex-1 space-y-3 pt-1 md:pt-0">
                  <div className="space-y-1">
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-slate-200 shadow-inner">
                        {getGreeting()}
                      </span>
                      <span className="badge-patient !px-3 !py-1 !text-[10px] whitespace-nowrap">
                        Paciente
                      </span>
                    </div>

                    {!profile ? (
                      <div className="h-10 w-52 rounded-xl bg-slate-800/80 animate-pulse" />
                    ) : (
                      <h1 className="max-w-3xl text-3xl font-black uppercase leading-[0.92] tracking-tight sm:text-4xl md:text-5xl">
                        <span className="bg-gradient-to-r from-sky-400 via-cyan-300 to-violet-400 bg-clip-text text-transparent drop-shadow-[0_12px_30px_rgba(56,189,248,0.2)]">
                  ...
                  <p className="max-w-3xl text-sm font-bold leading-relaxed text-slate-300 sm:text-base">
                    Bem-vindo a FisioCareHub, sua plataforma de reabilitação domiciliar e performance.
                  </p>

                  <div className="flex flex-wrap gap-2 pt-1">
                    <span className="inline-flex items-center gap-2 rounded-full border border-sky-400/25 bg-sky-400/10 px-4 py-2 text-[10px] font-black uppercase tracking-[0.22em] text-sky-300">
                      <Sparkles size={13} />
                      Perfil do paciente
                    </span>
                    <span className="inline-flex items-center gap-2 rounded-full border border-violet-400/20 bg-violet-400/10 px-4 py-2 text-[10px] font-black uppercase tracking-[0.18em] text-violet-200">
