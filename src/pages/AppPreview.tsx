...
export default function AppPreview() {
  ...
  const generateImage = async () => {
    // Image generation disabled as per user request to use Groq (which doesn't support image generation)
    setImageUrl('https://picsum.photos/seed/fisiocare/1080/1920');
  };
