...
async function registrationOptions(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const options = await generateRegistrationOptions({
      ...
      // credential_id antigo, vazio ou fora de base64url no banco.
      // Depois que o primeiro cadastro estiver funcionando, podemos reativar isso
      // com validação mais rígida se necessário.
      excludeCredentials: [],
